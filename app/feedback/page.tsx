...
const MSMEFeedbackPage = () => {
  ...
  const [feedback, setFeedback] = useState<FeedbackBody>();
  ...
  const handleFeedbackSelect = (rating: number) => {
    setFeedback((prev) => {
      return {
        rating,
        ...
        <div className="max-w-md w-full">
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600 text-sm" style={staggerDelay(1.6)}>
                Let us know your experience with the scheme recommendations.
              </p>
            </div>

            {/* Feedback Buttons */}
            <div className="flex space-x-4 mb-6" style={staggerDelay(1.8)}>
              <button
                onClick={() => handleFeedbackSelect(1)}
              ...
              <button
                onClick={() => handleFeedbackSelect(0)}
                className={`flex-1 flex items-center justify-center space-x-2 py-3 px-4 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-md ${
                  feedback?.rating === 0
            ...
            {/* Feedback Text Area */}
            <div className="mb-6" style={staggerDelay(2)}>
            ...
            <button
              ...
              disabled={
                !feedback?.feedback_text || feedback.rating === undefined
              }
